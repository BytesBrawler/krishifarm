import 'package:krishfarm/data/urls.dart';
...
class ApiRepo {
  ...
  Future<dynamic> navigationFarmerAi(var data) async {
    print(data);
    dynamic response = _apiService.postApi(data, AppUrl.navigationFarmerAI);
    return response;
  }
