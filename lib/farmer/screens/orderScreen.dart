// import 'package:krishfarm/models/OrderedProduct.dart';
// import 'package:krishfarm/services/database/seller_database_helper.dart';
...
import 'webSceens/ChatScreen.dart';
...
class _OrderScreenState extends State<OrderScreen> {
  ...
  Widget _buildOrderCard(OrderedProduct order) {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        final buyerId = snapshot.data!['buyerId'] ?? 'Unknown Location';
        final productId = snapshot.data!['productId'] ?? 'Unknown Location';
        final sellerId = snapshot.data!['sellerId'] ?? 'Unknown Location';
        return Container(
  ...
  Future<Map<String, dynamic>> _fetchOrderDetails(OrderedProduct order) async {
    ...
    final ownerId = product?.owner ?? 'Unknown ';
    ...
    return {
      'productId': order.productUid.toString(),
      'sellerId': ownerId,
