...
import 'package:krishfarm/farmer/screens/WeatherScreen/weatherservice.dart';
...
import 'package:krishfarm/farmer/screens/webSceens/fillform.dart';
import 'package:krishfarm/farmer/services/UserInfoProvider.dart';
import 'package:krishfarm/farmer/widgets/crop_inside_carousel.dart';
import 'package:krishfarm/services/authentification/authentification_service.dart';
                  ...
                  GridView.count(
                    ...
                    children: [
                                    ...
                                    children: <Widget>[
                                      ...
                                      ElevatedButton(
                                          onPressed: () => Application.router
                                              .navigateTo(
                                                  context, '/add-product'),
                                          child: const Text('Fill Directly')),
                                      //   child: const Text('Fill Directly')),
                                      ElevatedButton(
                                          onPressed: () async {
                                            final currentUser =
                      ...
                      _buildQuickActionButton(
                        ...
                        label: isEnglish ? 'Add Crop' : 'फसल कैलेंडर',
                        onTap: () => Application.router
                      ...
                      //   onTap: () => Provider.of<UserInfoProvider>(context,
                      //           listen: false)
                      //       .logOut(context),
                      // ),
                    ],
