...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:krishfarm/farmer/screens/CalenderScreen/local_widgets/CropDropDownList.dart';
...
class CropFieldProvider {
  ...
  static void showCropDropdown(BuildContext context,
      Function(String) selectValues, String dropdownType, String selectedItem) {
    showDialog(
      context: context,
      builder: (context) => CropDropdownLists(
        selectValues,
        dropdownType,
  ...
  //     BuildContext context, Function(String) selectValues , String dropdownType) {
  //   showDialog(
  //     context: context,
  //     builder: (context) => CropDropdownList(selectValues , dropdownType),
  //   );
  // }
  ...
  Map<String, dynamic> cropData = {
    ...
    "Orange": {"harvestTime": 365},
    "Tomato": {"harvestTime": 70},
    "banana": {"harvestTime": 70},
  };
